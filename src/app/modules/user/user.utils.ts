...
export const generateStudentId = async (
  academicSemester: IAcademicSemseter | null
): Promise<string> => {
  const currentId =
...
//==========generate student id ends==========

//==========generate faculty id starts==========
...
//==========generate faculty id ends==========

//==========generate admin id starts==========
